...
export default function PagePrice() {
  return (
    <div className="rounded-lg border border-gray-200 py-6 px-4 sm:py-8 sm:px-6 lg:py-10 lg:px-8">
      <div className="text-center mb-4 sm:mb-6">
        {/* Billing Toggle */}
        <div className="inline-flex items-center gap-1 sm:gap-2 p-0.5 sm:p-1 bg-gray-100 rounded-full mb-4 sm:mb-6">
          <button className="px-4 py-1.5 sm:px-6 sm:py-2 rounded-full text-xs sm:text-sm font-nanumNeo font-medium transition-all bg-white text-gray-900 shadow-sm">
            크래딧
          </button>
          <button className="px-4 py-1.5 sm:px-6 sm:py-2 rounded-full text-xs sm:text-sm font-nanumNeo font-medium transition-all text-gray-600 hover:text-gray-900">
            월간
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
        ...
        <div className="relative rounded-lg border-2 border-gray-200 p-4 sm:p-5 lg:p-6">
          <div className="mb-4 sm:mb-6">
            ...
            <div className="flex flex-wrap items-baseline gap-1 sm:gap-2 mb-1">
              <span className="text-2xl sm:text-3xl font-bold text-gray-900 font-paperlogy">
                무료
              </span>
          ...
          <ul className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
            <li className="flex items-start gap-2">
              ...
              <span className="text-xs sm:text-sm text-gray-700 font-nanumNeo break-keep">
                제한된 공개 이미지 생성
              </span>
            </li>
            <li className="flex items-start gap-2">
        ...
        <div className="relative rounded-lg border-2 border-brand shadow-lg lg:scale-105 p-4 sm:p-5 lg:p-6">
          <Badge
            variant="destructive"
            className="absolute -top-2 sm:-top-3 left-1/2 -translate-x-1/2 px-2 py-0.5 sm:px-3 sm:py-1 text-xs sm:text-sm font-nanumNeo"
          >
            가장 인기
          </Badge>
          ...
          <Button
            variant="destructive"
            size="sm"
            className="w-full text-xs sm:text-sm sm:h-10 lg:h-11"
          >
            Plus 플랜 시작하기
          </Button>
        </div>
      ...
      <div className="border-t border-gray-200 pt-4 sm:pt-6">
        <h4 className="text-xl font-bold text-gray-900 mb-2 font-paperlogy">
          환불 정책
        </h4>
        <ul className="space-y-1 text-sm text-muted-foreground font-nanumNeo leading-relaxed list-disc list-inside">
          <li>
        ...
        <p className="text-gray-500 mt-3 text-sm font-nanumNeo">
          자세한 환불 정책은{" "}
          <a
            href="/refund"
